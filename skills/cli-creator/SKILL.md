---
name: cli-creator
description: Use when turning an API, OpenAPI spec, SDK, admin tool, or local script into a reusable CLI with stable JSON, authentication, and cross-repo installation.
---
