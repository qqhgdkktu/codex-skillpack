...
description: Use only when explicitly asked to threat-model a repository or path by mapping assets, trust boundaries, attacker capabilities, abuse paths, and mitigations.
---
