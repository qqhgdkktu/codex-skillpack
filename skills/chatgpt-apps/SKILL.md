---
name: chatgpt-apps
description: Use when building or troubleshooting ChatGPT Apps SDK projects that combine MCP tools with widget UI; verify current OpenAI documentation before coding.
---
